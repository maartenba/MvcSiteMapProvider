...
namespace MvcSiteMapProvider.Builder
{
    ...
    public interface ISiteMapNodeCreator
    {
        ...
        ISiteMapNodeParentMap CreateSiteMapNode(string key, string parentKey, string sourceName, string implicitResourceKey);
        ...
        /// <param name="implicitResourceKey">The implicit resource key for localization of the node's properties.</param>
        /// <returns>An <see cref="T:MvcSiteMapProvider.Builder.ISiteMapNodeParentMap"/> instance.</returns>
        ISiteMapNodeParentMap CreateDynamicSiteMapNode(string key, string parentKey, string sourceName, string implicitResourceKey);
        ...
        string GenerateSiteMapNodeKey(string key, string url, string title, string area, string controller, string action, string httpMethod, bool clickable);
    }
}
