...
Note that if you are using .NET 4, we already created the AppStart_MvcSiteMapProvider_Bootstrapper_Autofac.cs file which registers the IControllerFactory.
